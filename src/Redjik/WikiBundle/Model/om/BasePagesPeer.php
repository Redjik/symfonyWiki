...
use Redjik\WikiBundle\Model\map\PagesTableMap;
...
abstract class BasePagesPeer
{
    ...
    const OM_CLASS = 'Redjik\\WikiBundle\\Model\\Pages';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Redjik\\WikiBundle\\Model\\map\\PagesTableMap';
    ...
    /** the column name for the fullpath field */
    const FULLPATH = 'pages.fullpath';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Text', 'Alias', 'Fullpath', 'Parent', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'text', 'alias', 'fullpath', 'parent', ),
        BasePeer::TYPE_COLNAME => array (PagesPeer::ID, PagesPeer::TITLE, PagesPeer::TEXT, PagesPeer::ALIAS, PagesPeer::FULLPATH, PagesPeer::PARENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'TEXT', 'ALIAS', 'FULLPATH', 'PARENT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'text', 'alias', 'fullpath', 'parent', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Text' => 2, 'Alias' => 3, 'Fullpath' => 4, 'Parent' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'text' => 2, 'alias' => 3, 'fullpath' => 4, 'parent' => 5, ),
        BasePeer::TYPE_COLNAME => array (PagesPeer::ID => 0, PagesPeer::TITLE => 1, PagesPeer::TEXT => 2, PagesPeer::ALIAS => 3, PagesPeer::FULLPATH => 4, PagesPeer::PARENT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'TEXT' => 2, 'ALIAS' => 3, 'FULLPATH' => 4, 'PARENT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'text' => 2, 'alias' => 3, 'fullpath' => 4, 'parent' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PagesPeer::TEXT);
            $criteria->addSelectColumn(PagesPeer::ALIAS);
            $criteria->addSelectColumn(PagesPeer::FULLPATH);
            ...
            $criteria->addSelectColumn($alias . '.fullpath');
    ...
    {
        // Invalidate objects in PagesPeer instance pool,
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PagesPeer::addSelectColumns($criteria);
        $startcol2 = PagesPeer::NUM_HYDRATE_COLUMNS;
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePagesPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Redjik\WikiBundle\Model\map\PagesTableMap());
      }
    }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += PagesPeer::doOnDeleteCascade(new Criteria(PagesPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += PagesPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = PagesPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related Pages objects
            $criteria = new Criteria(PagesPeer::DATABASE_NAME);

            $criteria->add(PagesPeer::PARENT, $obj->getId());
            $affectedRows += PagesPeer::doDelete($criteria, $con);
        }
